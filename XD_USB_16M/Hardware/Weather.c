...
#define RainClearCRC_H		0x41
#define RainClearCRC_L		0x0F
...
uint8_t Rain_clear[8]={WeatherID,RS485WRITE_FUN_CODE,RS485WriteAdd_H,RS485WriteAdd_L,0X00, 0x01,RainClearCRC_H,RainClearCRC_L};
